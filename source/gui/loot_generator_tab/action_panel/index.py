...
class ActionPanel:
    def __init__(
        ...
        self.rhFunList = [
            method
            for method in dir(Randomizer_Handler)
            if method.startswith("__") is False
        ]

        boarder1 = tk.Frame(
            self.frame,
            highlightcolor=color["label text"],
            highlightbackground=color["label text"],
        ...
        ttk.Button(
            ...
            text="Individual\nTreasure",
            state="normal",
            command=self.individualTreasureB,
        ...
        ttk.Button(
            boarder3, text="Weapon Drop", state="normal", command=self.weaponDropB
        ).grid(row=0, column=0, sticky="nesw", ipady=23)
        ...
        ttk.Button(
            boarder4, text="Art & Gems", state="normal", command=self.artgemB
        ).grid(row=0, column=0, sticky="nesw", ipady=23)
        ...
        ttk.Button(
            boarder5, text="Enchanted Rune", state="normal", command=self.runeB
        ).grid(row=0, column=0, sticky="nesw", ipady=23)
        ...
        ttk.Button(
            boarder6, text="Roll Specific Item", state="normal", command=self.rollItemB
        ).grid(row=0, column=0, sticky="nesw", ipady=23)
