...
class MyStyles:
    ...
    def set_ttk_element_styles(cls) -> None:
        ...
        style.configure(
            "TNotebook.Tab",
            background=cls.COLOR_UNTAB,
            foreground=cls.COLOR_NOTEBOOK_FG,
            font=cls.FONT_STD,
            padding=(19, 1),
        )
        ...
        style.map(
            "TNotebook.Tab",
            background=[("selected", cls.COLOR_BACKGROUND)],
            foreground=[("selected", cls.COLOR_LABEL_TXT)],
        )
        ...
        style.configure(
            ...
            foreground=cls.COLOR_SELECTED,
            height=4,
            width=5,
            focuscolor=cls.COLOR_BUTTON,
            justify="center",
        )
        ...
        style.configure(
            ...
            padx=0,
            pady=0,
            background=cls.COLOR_BUTTON,
            foreground=cls.COLOR_LABEL_TXT,
            height=4,
            width=18,
            focuscolor=cls.COLOR_BUTTON,
            justify="center",
        ...
        style.configure(
            ...
            foreground=cls.COLOR_LABEL_TXT,
            background=cls.COLOR_BACKGROUND,
            indicatorcolor=cls.COLOR_NOT_SELECTED,
            focuscolor=cls.COLOR_BACKGROUND,
            font=cls.FONT_STD,
        )
        style.map(
            "TRadiobutton",
        ...
        style.configure(
            "Vertical.TScrollbar",
            arrowcolor=cls.COLOR_SELECTED,
            background=cls.COLOR_SCROLLBAR,
            bordercolor=cls.COLOR_DISABLED,
        ...
        style.configure(
            "Treeview",
            foreground=cls.COLOR_TXT_FG,
            background=cls.COLOR_TXT_BG,
            indicatorcolor=cls.COLOR_NOT_SELECTED,
            focuscolor=cls.COLOR_BACKGROUND,
            font=cls.FONT_TREEVIEW,
